...
//
// This file carries no build tag, unlike the three commands behind
...
// 'rekey', and 'rotate' from behind its tag.
//
...
// other command in the namespace uses too: 'create', 'rekey', and 'rotate'
// all replace files whose half-written state would be a ciphertext no
// machine can decrypt or a registry no flake can parse.
